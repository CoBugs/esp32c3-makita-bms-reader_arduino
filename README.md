...
*   Резистор **4.7 кОм** 2 шт. (подтягивающий резистор, рекомендуется для совместимости со старыми батареями номинал подбирать до уверенного просыпания батареи 2,2кОм а то и ниже).
...
10.  Загрузка шаблона сайта:
     ...
     * Выберите вашу плату и COM-порт в верхней панели. 
     * Нажмите комбинацию клавиш Ctrl + Shift + P для Win (или Cmd + Shift + P на Mac), чтобы открыть Палитру команд. 
     * Введите в появившейся строке поиска:Для LittleFS: Upload LittleFS to Pico/ESP8266/ESP32.Для SPIFFS: Upload SPIFFS to Pico/ESP8266/ESP32. 
     * Кликните по этой команде. В терминале снизу начнется сборка образа и его прошивка в память платы.
